  ...
  <div class="projects">
    ...
    <div class="container">
      <div class="layout-grid">
        ...
        <a href="https://atisolarsystem.vercel.app/" class="card" target="_blank">
          <img src="https://i.ibb.co/35CsrztD/Screenshot-2025-07-04-131426.png" class="img" alt="Infographic Image" />
          <div class="description">
            <h3>Solar System Explorer</h3>
            <p>Interactive Solar System Explorer with 3D Visualization.</p>
          </div>
        </a>
